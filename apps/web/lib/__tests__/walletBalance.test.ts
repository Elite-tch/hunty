...
describe("isStellarPublicKey", () => {
  ...
  it.each([
    ...
    [
      "contains 0/1 (not in base32 alphabet)",
      "G01P2KPQGKIHYJGXNUIYOMHARUARCA7DJT5FO2FFOOKY3B2WSQHG4W37",
    ],
...
describe("fetchWalletBalance", () => {
  ...
  it("returns the native balance", async () => {
    ...
    expect(snapshot.tokens).toEqual([{ assetCode: "USDC", assetIssuer: "", balance: 10 }]);
  });
