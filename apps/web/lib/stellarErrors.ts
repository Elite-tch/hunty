...
const TX_CODE_MAP: Record<string, { code: StellarErrorCode; message: string }> = {
  tx_insufficient_fee: {
    ...
    message:
      "Insufficient fee supplied for transaction. Increase the fee or add more XLM to your account.",
  },
  ...
  tx_no_source_account: {
    code: "UNKNOWN",
    message:
      "Source account not found on the network. Ensure your wallet is on the correct network.",
  },
};
