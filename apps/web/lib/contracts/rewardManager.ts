...
import { getRequiredRewardManagerAddress, NETWORK_PASSPHRASE, SOROBAN_RPC_URL } from "./config";
...
async function submitRewardReceipt(
  action: string,
...
async function claimRewardInternal(
  huntId: number,
  signal?: AbortSignal
...
export async function sponsorHunt(huntId: number, amount: number): Promise<SponsorContribution> {
...
export function getPlayerRewardReceipt(
  huntId: number,
  playerAddress?: string
): RewardReceipt | null {
