...
import { parseStellarError, type StellarError, type StellarErrorCode } from "@/lib/stellarErrors";
...
const ERROR_MESSAGE_MAP: Record<string, string> = {
  // Wallet errors
  WALLET_NOT_FOUND: "No compatible wallet detected. Install the Freighter extension and try again.",
  ...
  TX_BAD_AUTH: "Transaction authorisation failed. Reconnect your wallet and try again.",
  TRANSACTION_TIMEOUT: "Transaction timed out. Please check your network connection and try again.",
  ...
  CONTRACT_HUNT_NOT_FOUND: "Hunt not found on-chain. It may have been removed.",
  CONTRACT_UNAUTHORIZED: "You are not authorised to perform this action.",
  CONTRACT_CLUE_ALREADY_ANSWERED: "This clue has already been answered.",
  CONTRACT_CLUE_LOCKED: "This clue is locked. Solve the previous clue first.",
  ...
  USER_REJECTED: "Transaction was cancelled. Please try again when you're ready.",
  BROWSER_REQUIRED: "Browser environment required.",

  // Network / query errors
  NETWORK_ERROR: "Network error. Please check your internet connection and try again.",
  QUERY_FAILED: "Unable to complete the request. Please try again.",
};
 ...
 */
export function normalizeNetworkError(error: unknown, fallbackMessage: string): Error {
