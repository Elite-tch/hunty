    ...
    <div role="main" className="min-h-screen bg-stone-950 flex items-center justify-center px-6">
      <div className="text-center max-w-md">
        ...
        <div className="flex gap-3 justify-center">
          <Link href="/dashboard" className="btn-stellar-green-sm">
            Browse Hunts
          </Link>
          <Link
            href="/"
            className="rounded-xl border border-stone-700 px-5 py-2.5 text-stone-400 text-sm font-semibold hover:text-cream hover:border-stone-500 transition-all"
          >
            Go Home
          </Link>
        </div>
