...
describe("PlayerProgressPanel", () => {
  it("renders correctly with given progress data", () => {
    render(<PlayerProgressPanel cluesSolved={2} totalClues={5} totalPoints={150} />);
  ...
  it("calculates percentage correctly and sets ARIA styles", () => {
    ...
    render(<PlayerProgressPanel cluesSolved={3} totalClues={10} totalPoints={999} />);
  ...
  it("handles zero totalClues gracefully to avoid NaN or Infinity", () => {
    render(<PlayerProgressPanel cluesSolved={0} totalClues={0} totalPoints={0} />);
