...
export const HuntCompletionEmail: React.FC<Readonly<HuntCompletionEmailProps>> = ({
  ...
  >
    ...
    >
      ...
      >
        <h1 style={{ color: "#ffffff", margin: 0, fontSize: "24px" }}>Hunt Completed! 🎉</h1>
      </div>
      ...
      <div style={{ padding: "32px" }}>
        ...
        <p style={{ fontSize: "16px", lineHeight: "24px", color: "#4b5563", marginBottom: "32px" }}>
          Great news! A user has just successfully completed your scavenge hunt{" "}
          <strong>{huntName}</strong>.
        </p>
        ...
        <div style={{ textAlign: "center" }}>
          <a
            href={`${process.env.NEXT_PUBLIC_APP_URL || "https://hunty.app"}/dashboard`}
            style={{
