          ...
          return (
            ...
            >
              <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
                <div>
                  ...
                  <p className="mt-1 text-xs text-slate-500 dark:text-slate-400">
                    Pool {formatXlm(escrow?.totalPool ?? hunt.rewardPool)} - {receipts.length}{" "}
                ...
                <Button
                  ...
                  title={
                    canRefund
                      ? "Refund unclaimed rewards"
                      : "Refunds unlock after expiry when escrow has a balance"
                  }
                >
              ...
              <div className="mt-3 divide-y divide-slate-200 overflow-hidden rounded-xl border border-slate-200 bg-white text-sm dark:divide-white/10 dark:border-white/10 dark:bg-slate-950">
                {receipts.length === 0 ? (
                  <p className="px-3 py-3 text-slate-500 dark:text-slate-400">
                  ...
                  receipts.map((receipt) => (
                    <div
                      key={receipt.id}
                      className="grid gap-2 px-3 py-3 sm:grid-cols-[120px_1fr_110px] sm:items-center"
                    >
