      ...
      <DialogContent className="sm:max-w-md text-center">
        ...
        <div className="space-y-4">
          <p className="bg-gradient-to-b from-[#787884] to-[#576065] text-transparent bg-clip-text text-2xl font-medium">
            You are about to publish your game &quot;{gameName}&quot; and will incur the following
            deductions from your balance.
          </p>
          ...
          <div className="flex gap-4">
            <Button
              ...
              style={{
                backgroundImage:
                  "linear-gradient(white, white), linear-gradient(to bottom, #2D4FEB, #0C0C4F)",
            ...
            <Button
              onClick={onPublish}
              className="flex-1 bg-gradient-to-b from-[#39A437] to-[#194F0C] hover:bg-green-700 text-white text-xl cursor-pointer"
            >
              Publish
            </Button>
          </div>
