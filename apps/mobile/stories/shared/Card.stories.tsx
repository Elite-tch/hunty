...
const children = (
  <>
    <CardHeader>
      <CardTitle>
        <ThemedCustomText variant="h3">Hunt Card</ThemedCustomText>
      </CardTitle>
    </CardHeader>
    <CardContent>
      <ThemedCustomText variant="body">Card body content.</ThemedCustomText>
    </CardContent>
    <CardFooter>
      <ThemedCustomText variant="caption">Footer info</ThemedCustomText>
    </CardFooter>
  </>
);
